    ...
    public function index(): Response
    {
        ...
        return Inertia::render('TenantAdmin/SupportTickets/Settings/Index', [
            ...
            'emailSettings' => $emailSettings ? [
                ...
                'imap_encryption' => $emailSettings->imap_encryption,
                'imap_folder' => $emailSettings->imap_folder,
                'imap_enabled' => $emailSettings->imap_enabled,
                'imap_last_check_at' => $emailSettings->imap_last_check_at,
                'imap_last_check_successful' => $emailSettings->imap_last_check_successful,
                'imap_last_check_error' => $emailSettings->imap_last_check_error,
            ] : null,
            'permissions' => [
