...
export default function Customdashboard({ pageTitle }) {
    return (
        <AuthenticatedLayout
            header={
        ...
        >
            <Head title={pageTitle || 'CustomDashboard'} />
            
            <div className="py-6">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="mb-8">
                        <h1 className="text-2xl font-bold text-gray-900">CustomDashboard</h1>
                    ...
                    <div className="bg-white shadow rounded-lg p-6">
                        <div className="text-center py-16">
                            ...
                            <h3 className="text-lg font-medium text-gray-900 mb-2">Welcome to CustomDashboard</h3>
                            <p className="text-gray-500 max-w-sm mx-auto">
                                This is your custom CustomDashboard page. Start building your content here.
                            </p>
                            <div className="mt-6">
